...
def test_advance_date_biweekly():
    assert advance_date(date(2026, 1, 5), "biweekly") == date(2026, 1, 19)
    assert advance_date(date(2026, 12, 28), "biweekly") == date(2027, 1, 11)
...
def test_advance_date_semiannual_preserves_intended_day():
    july = advance_date(date(2026, 1, 31), "semiannual", intended_day=31)
    assert july == date(2026, 7, 31)
    january = advance_date(july, "semiannual", intended_day=31)
    assert january == date(2027, 1, 31)

    february = advance_date(date(2024, 8, 31), "semiannual", intended_day=31)
    assert february == date(2025, 2, 28)
    august = advance_date(february, "semiannual", intended_day=31)
