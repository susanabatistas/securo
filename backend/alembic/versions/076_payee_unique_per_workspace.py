...
Renumbered from upstream's 072 to 076 when merging upstream/main into this
fork — 072 was already taken here by an unrelated fork-only migration
(workspace_kind_normalize).
